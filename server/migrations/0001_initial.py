    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(default=None, max_length=12, null=True, blank=True)),
                ('carpentry', models.CharField(default=None, max_length=30, null=True, blank=True)),
                ('concrete_forming', models.CharField(default=None, max_length=30, null=True, blank=True)),
                ('available', models.CharField(default=None, max_length=3, null=True, blank=True)),
                ('device', models.ForeignKey(default=None, to='push_notifications.GCMDevice')),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
            ],
        ),
